...
class BackUpServiceTest {
    ...
    public void getRecentBackUpHistoryTest() throws Exception {
        //given
        ...
        back3 = em.find(BackUp.class, back3.getId());
        //when
        BackUpHistoryResponse backUpHistoryResponse = backUpService.getBackUp(avatar.getId());
        //then
        assertThat(backUpHistoryResponse.getBackUpId()).isEqualTo(back3.getId());
        assertThat(backUpHistoryResponse.getDate()).isEqualTo(back3.getCreatedDate());
        assertThat(backUpHistoryResponse.getOsVersion()).isEqualTo(back3.getOsVersion());
        assertThat(backUpHistoryResponse.getDeviceModel()).isEqualTo(back3.getDeviceType());
        assertThat(backUpHistoryResponse.getCount()).isEqualTo(back3.getCount());
    }
    ...
    public void getRecentBackUpNullTest() throws Exception {
        ...
        //when
        //then
        assertThrows(NotExistBackUpHistoryException.class, () -> backUpService.getBackUp(Long.MAX_VALUE));
    }
    ...
    void createTestIfNotExistBeforeBackUp() throws Exception {
        ...
        //when
        BackUpHistoryResponse response = backUpService.backup(diaryEventRequestList, newPerson.getId());
        ...
        assertThat(diaryList.get(0).getBackUp().getId()).isEqualTo(response.getBackUpId());
        assertThat(diaryList.size()).isEqualTo(response.getCount());
    }
    ...
    public void createTestIfNotExistBeforeBackUpAndExistEventList() throws Exception {
        ...
        assertThat(response.getBackUpId()).isEqualTo(diaryList.get(0).getBackUp().getId());
        assertThat(response.getCount()).isEqualTo(diaryList.get(0).getBackUp().getCount());
    }
    ...
    public void backUpEntityUpdateTest() throws Exception {
        ...
        //when
        BackUpHistoryResponse response = backUpService.backup(diaryEventRequestList, avatar.getId());

        //then
        BackUp findBackUp = backUpRepository.findBackUpByIdLatest(avatar.getId()).get();

        assertThat(findBackUp.getId()).isEqualTo(response.getBackUpId());
        assertThat(response.getBackUpId()).isEqualTo(findBackUp.getId());
        assertThat(response.getCount()).isEqualTo(findBackUp.getCount());
    }
    ...
    public void diaryTest1IfBackUpExist() throws Exception {
        ...
        assertThat(response.getBackUpId()).isEqualTo(findDiaryList.get(0).getBackUp().getId());
        assertThat(response.getCount()).isEqualTo(findDiaryList.get(0).getBackUp().getCount());
    ...
    public void createDiaryTest2() throws Exception {
        ...
        List<Diary> findDiaryList = diaryRepository.findDiariesByIdAndAvatarIdAndBackUpId(findBackUp.getId(), avatar.getId());
        //then
        assertThat(findDiaryList).extracting("title").contains(editEventRequest1_1.getTitle());
        assertThat(findDiaryList).extracting("title").contains(editExistEventRequest1_Last.getTitle());
        assertThat(findDiaryList).extracting("title").contains(diary2.getTitle());
        assertThat(findDiaryList).extracting("title").contains(diary3.getTitle());

        assertThat(findDiaryList).extracting("content").contains(editEventRequest1_1.getContent());
        assertThat(findDiaryList).extracting("content").contains(editExistEventRequest1_Last.getContent());
        assertThat(findDiaryList).extracting("content").contains(diary2.getContent());
        assertThat(findDiaryList).extracting("content").contains(diary3.getContent());

        assertThat(findDiaryList).extracting("kind").contains(editEventRequest1_1.getDiaryKind());
        assertThat(findDiaryList).extracting("kind").contains(createEventRequest1.getDiaryKind());
        assertThat(findDiaryList).extracting("kind").contains(diary2.getKind());
        assertThat(findDiaryList).extracting("kind").contains(diary3.getKind());
    ...
    public void getRecentBackUpTest() throws Exception {
        ...
        //then
        assertThat(backUpHistoryResponse.getBackUpId()).isEqualTo(back3.getId());
        assertThat(backUpHistoryResponse.getCount()).isEqualTo(5);
    }

    @Test
    @DisplayName("만약 백업이 존재하지 않는 경우 예외를 출력한다. ")
    public void getRecentBackUpNotExistTest() throws Exception {
        //given
        //when
        //then
        assertThrows(NotExistBackUpHistoryException.class, () -> backUpService.getBackUp(Long.MAX_VALUE));
    ...
    @Test
    @DisplayName("백업 아이디와 avatarId를 요청하여 일기 복원을 요청한 경우 저장된 일기 리스트와 백업 히스토리를 내려준다.")
    public void diaryRestoreTest() throws Exception {
        //given
    ...
    @Test
    @DisplayName("일기가 존재하지 않는 경우 일기가 존재하지 않는다는 예외를 출력한다.")
    public void diaryRestoreNotExistTest() throws Exception {
        //given
        //when
        //then
        BackUp notExistBackUp = BackUp.of("iphone99", "iphone33", avatar);
        assertThrows(NotExistBackUpHistoryException.class, () -> backUpService.restoreDiary(avatar.getId(), notExistBackUp.getId()));
    }
}